...
const DropDown = () => {
  ...
  <DropdownMenuContent className="text-gray-400">
    ...
    <DropdownMenuItem onClick={handlSignout} className="text-gray-100 text-md font-medium focus:bg-transparant focus:text-yellow-500 transition-colors cursor-pointer">
